...
module.exports = {
  ...
  torznab: [
    "http://prowlarr.trux.dev/3/api?apikey={{ .PROWLARR__API_KEY }}", // ipt
    "http://prowlarr.trux.dev/4/api?apikey={{ .PROWLARR__API_KEY }}", // tl
    ...
    "http://prowlarr.trux.dev/11/api?apikey={{ .PROWLARR__API_KEY }}", // fl
